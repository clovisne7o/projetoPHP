...
<body>
        ...
        <div class="row">
            <div class="col">                            
                <form method="POST">
                    ...
                    <input type="text" class="form-control" name="nome" placeholder="Nome Filiado">
                    <input type="text" class="form-control" name="cpf" placeholder="CPF Filiado">
            ...
            <div class="col">
                ...
                <table class="table">
                    ...
                    <tbody class="fs-6 text-center">                                              
                        <?php
                        $selecao =$conn->PREPARE("SELECT * FROM filiado;");
                        $selecao->execute();
    ...
    <?php        
        if(isset($_POST['nome'])&&isset($_POST['bairro'])&&isset($_POST['cpf'])){
            ...
            $cpf = $_POST['cpf'];
            $bairro = $_POST['bairro'];
            $stmt = $conn->prepare("INSERT INTO filiado (nome,bairro,cpf) VALUES (:N, :B, :C)");
